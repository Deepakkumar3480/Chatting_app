  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
        { Array.isArray(messages) && messages.filter((msg) => msg && typeof msg === "object").map((msg, index) => (
          // console.log(msg);
          <div
            key={index}
          ...
          >
            {msg?.image ? (
              <img
                src={msg.image}
                alt="msgimage"
                className="max-w-[230px] border border-gray-700 rounded-lg pverflow-hidden mb-8"
              />
            ) : (
              <p
